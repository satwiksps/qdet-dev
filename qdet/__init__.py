"""Quantum Data Engineering Toolkit (QDET) - Enterprise Edition v0.3.0
...
Architecture Layers:
1. Core (qdet.core): Base classes and exceptions
2. Connectors (qdet.connectors): Data loading, SQL, Parquet, serialization
3. Transforms (qdet.transforms): Dimensionality reduction, cleaning, scaling
4. Encoders (qdet.encoders): Feature encoding into Hilbert space
5. Analytics (qdet.analytics): ML algorithms (SVC, KMeans, anomaly detection, etc.)
6. Compute (qdet.compute): Execution, backend management, circuit optimization
7. Governance (qdet.governance): Monitoring, drift detection, cost tracking
"""
